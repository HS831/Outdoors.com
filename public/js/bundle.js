      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            // console.log(res);
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Reset Password Token Sent to Email');
              window.setTimeout(function () {
...
var forgotForm = document.querySelector('.form--forgotpwd');
...
if (forgotForm) {
  forgotForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.getElementById('email').value; // const password = document.getElementById('password').value;

    console.log(email);
    (0, _forgotPassword.forgotpwd)(email);
  });
}
...
if (updatePassword) {
  updatePassword.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
